              ...
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={4} align="center" sx={{ py: 4, color: "#6f7f77" }}>
                    No category grid sections found.
                  </TableCell>
                </TableRow>
              ) : (
                filteredRows.map((section, index) => {
                  ...
                  return (
                    <TableRow key={sectionId || `section-${index}`} hover sx={{ cursor: sectionId ? "pointer" : "default" }} onClick={() => sectionId && navigate(`/admin/homepage-cms/category-grid-sections/${encodeURIComponent(String(sectionId))}`)}>
                      <TableCell>
