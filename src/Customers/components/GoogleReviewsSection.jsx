...
export default function GoogleReviewsSection() {
  ...
  return (
    ...
    >
      {/* Max-width inner wrapper — keeps content contained on large screens */}
      <Box sx={{ maxWidth: 1280, mx: "auto", px: { xs: 3, sm: 5, md: 6 } }}>
        {/* Section header */}
        <Box
          sx={{
            display: "flex",
        ...
        <Box sx={{ position: "relative" }}>
          {/* Left arrow — always visible, positioned just outside the card track */}
          <IconButton
            onClick={() => scroll("left")}
            size="small"
            sx={{
